 ...
 */
public class SetUserFirebaseTokenJob extends Job {
    private String firebaseToken;
    private String token;
    private static final String TAG = "SetUserFirebaseTokenJob";
    ...
    public void onRun() throws Throwable {
        Call call = RestClient.getInstance().getUserFirebaseTokenService().setUserFirebaseToken(token, firebaseToken);
